...
def register_user(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # como iniciar sesión automáticamente, enviar un correo electrónico de confirmación, etc.
            return redirect('login_url')  # Reemplaza 'login_url' con la URL de inicio de sesión
    else:
